    ...
    <div class="d-flex flex-column flex-md-row">
        ...
        <div class="col-12 col-md-6 mx-auto">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('nutritionist.profile.update', auth()->user()->id) }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('put')
        ...
        <div class="col-12 col-md-5 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('nutritionist.profile.password', auth()->user()->id) }}" autocomplete="off">
                        @csrf
                        @method('put')
