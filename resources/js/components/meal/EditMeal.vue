        ...
        <div class="container-fluid">
          ...
          <div class="col-12 mx-auto">
            ...
            <div class="form-group">
              <div class="col-10" v-for="(f, i) in meal.foods" :key="i">
                <div class="row mt-2">
                  <div class="col-6">
                    <label for="food">
                      Alimento: <span class="text-danger">*</span>
                    </label>
                    <multiselect
                      v-model="f.food"
                      :options="comidas"
                  ...
                  <div class="col-2 text-center mt-4">
                    <button
                      class="btn btn-info btn-sm btn-block rounded py-2 mt-2"
                      @click="subFood(i)"
                    >
              ...
              <div class="col-2 mt-2">
                <button
                  class="btn btn-primary btn-sm btn-block rounded py-2"
                  @click="addFood"
                >
            ...
            <div class="col-10 mx-auto">
              <button
                class="btn btn-block btn-primary mt-4 mb-3"
                data-dismiss="modal"
                aria-label="Fechar"
                @click="sendToUp"
              >
...
export default {
  ...
  methods: {
    sendToUp() {
      ...
      this.$emit("editing", { meal: this.meal });
    },
    addFood() {
